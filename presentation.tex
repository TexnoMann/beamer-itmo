...
\title{Изучение практических аспектов идентификации на примере динамической модели робота-манипулятора}

\author[Author, Another]{
    \hfill
    {\bf Беспалов В.}\inst{1}
    \hfill
     {\bf Антипов В.}\inst{2}
    \hfill
}
...
\date[Occasion]{2 февраля 2021 \\ Пятидесятая научная и учебно-методическая конференция Университета ИТМО}
